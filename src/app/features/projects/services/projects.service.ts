...
export class ProjectsService {
  projectsInfo: Project[] = [
    ...
    },
    {
      ...
      imgProject: '../../assets/images/portfolio_2026.webp',
    ...
    },
    {
      ...
      isFeatured: true,
      longDescription:
        'Aplicação Full Stack completa de registro e login de usuários. O frontend foi construído em Angular com Angular Material para feedback visual e Guards para proteção de rotas. O backend em Express utiliza criptografia de senhas e JWT para sessões seguras. O design é totalmente responsivo, implementado com TailwindCSS e otimizado com PostCSS.',
      shortDescription: 'App Full Stack de registro com Angular e Node.js',
      imgProject: '../../assets/images/userRegisterApp.webp',
      urlGithub: 'https://github.com/IcaroMachadoCarvalho/UserRegisterApp.git',
      languages: [
        'Angular',
        'Node.js',
        'Express',
      ...
      languagesImgs: [
        '../../assets/images/angular-original.svg',
    ...
    },
    {
      id: 11,
      status: 'Finalizado',
      name: 'ReviewPlataform',
      isFeatured: true,
      longDescription:
        'Aplicação backend robusta em arquitetura MVC para avaliação de cursos. O sistema conta com autenticação JWT, controle de permissões por roles (Admin/User), CRUD completo de usuários, cursos e reviews, além de documentação interativa via Swagger. Desenvolvido com foco em escalabilidade usando Docker e qualidade de código com testes unitários e de integração.',
      shortDescription: 'Backend para plataforma de reviews com Node.js',
      imgProject: '../../assets/images/reviewPlataform.webp',
      urlGithub: 'https://github.com/IcaroMachadoCarvalho/reviewPlataform.git',
      languages: ['ExpressJS', 'MongoDB', 'Docker', 'Jest', 'Swagger', 'JWT'],
      languagesImgs: [
        '../../assets/images/nodejs-original.svg',
...

    {
      ...
      imgProject: '../../assets/images/luregi_2026.webp',
...

    {
      ...
      isFeatured: true,
      longDescription:
        'API REST desenvolvida com Spring Boot para gerenciamento de pratos em um ambiente de restaurante. O projeto aplica padrões rigorosos de arquitetura em camadas (Controller, Service, Repository), incluindo validações de dados de entrada, tratamento de exceções customizadas e documentação Swagger. Permite o controle de estoque e filtros avançados por status e preço.',
      shortDescription: 'API de gerenciamento de pratos com Spring Boot',
      imgProject: '../../assets/images/cardapioDigital.webp',
      urlGithub: 'https://github.com/IcaroMachadoCarvalho/cardapio-digital.git',
      languages: [
        'Java',
        'Spring Boot',
        'Swagger',
      ...
      languagesImgs: [
        '../../assets/images/java-original.svg',
        '../../assets/images/spring-original.svg',
      ],
    },
  ];
  ...
  constructor() {}
  getContentProjects() {
    return this.projectsInfo.reverse();
  }
